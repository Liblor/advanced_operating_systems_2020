...
__BEGIN_DECLS
// 1TB
#define MORECORE_VADDR_ZONE_SIZE (1024UL*1024*1024)
#define MORECORE_FREE_STATIC_THRESHOLD (100*BASE_PAGE_SIZE)
#define MORECORE_REFILL_SIZE (200*BASE_PAGE_SIZE)
